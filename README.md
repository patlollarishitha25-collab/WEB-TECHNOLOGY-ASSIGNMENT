...
**WEEK-3:**
   Developed a Job Registration Form using HTML with various form controls such as text fields, radio buttons, checkboxes, a dropdown list, a file upload option, and a success page displayed after form submission.

**WEEK-4:**
   Developed an **SBI Bank EMI Calculator** using HTML, CSS, and JavaScript.
The application accepts loan details from the user, calculates the monthly EMI, and displays the result instantly on the webpage.

**WEEK-5:**
   Developed a **Job Registration Form** using HTML, CSS, and JavaScript with client-     side validation.
 The program validates the user's name, email, and mobile number using regular expressions and displays appropriate success or error messages based on the input.
